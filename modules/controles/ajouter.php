...
?>
/* ==============================================
       AMÉLIORATIONS MOBILE (TABLEttes & TÉLÉPHONES)
       ============================================== */

/* Tablettes et mobiles en portrait (max-width: 768px) */
@media (max-width: 768px) {
    ...
    /* Actions container (boutons favorables/défavorables) */
    .actions-container {
        flex-direction: column;
        gap: 8px;
    }
    ...
    /* Grille des liens de parenté : passage en colonne */
    .liens-grid {
        grid-template-columns: 1fr;
        gap: 8px;
    }

    /* Cartes bénéficiaires en colonne */
    .row.g-2 .col-md-6 {
        margin-bottom: 10px;
    }
    ...
    /* Agrandir les cases à cocher et leurs labels */
    .form-check-input {
        width: 1.2rem;
        height: 1.2rem;
        margin-top: 0.2rem;
    ...
    /* Info militaire : passage en colonne */
    .militaire-info .info-grid {
        flex-direction: column;
        align-items: flex-start;
        gap: 0.5rem;
    ...
    /* Zone statut temporaire : boutons radio en ligne */
    .statut-temp .d-flex {
        flex-direction: column;
        align-items: flex-start;
        gap: 6px;
...
@media (max-width: 480px) {
    ...
    /* Réduction supplémentaire des marges */
    .card-modern .card-header {
        padding: 10px 12px;
        flex-direction: column;
        align-items: flex-start;
    ...
    /* Ajustement des badges mini dans les résultats de recherche */
    #search-results .badge-statut-mini {
        font-size: 0.55rem;
        padding: 1px 4px;
    }

    #search-results .badge-statut-mini i {
        font-size: 0.6rem;
    }
}
</style>
